  ...
  return (
    <nav className="flex flex-wrap justify-end items-center font-semibold">
      <ul className="flex flex-wrap justify-end items-center">
        ...
        <li>
          <Link href="/Register" className="flex flex-wrap text-center relative mx-3 hover:underline">Register</Link>
        </li>
        <li>
          <Link href="/FormLogin" className="flex flex-wrap text-center relative mx-3 hover:underline">Login</Link>
        </li>
